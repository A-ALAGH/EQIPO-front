    ...
    <Center py={6}>
      <Box maxW="270px" w="full" bg={useColorModeValue('white', 'gray.800')} boxShadow="2xl" rounded="md" overflow="hidden">
        ...
        <Flex justify="center" mt={-12}>
          <Avatar size="xl" src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-1.2.1&q=80&fm=jpg&crop=faces&fit=crop&h=200&w=200&ixid=eyJhcHBfaWQiOjE3Nzg0fQ" alt="Author" css={{ border: '2px solid white' }} />
        </Flex>
        <Box p={6}>
